...
export function initial(): State { return { version: 1, auth: false, store: '', connected: false, scan: 0, running: false, scenario: 'Normal', page: 'First Steps', selected: 'maya', employees: roles.map(([id, name, role, description]) => ({ id, name, role, description, status: 'Draft', channels: id === 'maya' ? ['Store chat'] : [], mode: 'guided', step: 0, reviewed: false, paused:false,settings:{}, configured: false, previewed: false })), integrations: { 'Store chat': false, Email: false, WhatsApp: false, Instagram: false }, knowledge: { 'Shipping & Delivery': { status: 'Ready', text: 'Sample policy: UK delivery in 3–5 working days.' }, 'Returns & Refunds': { status: 'Needs review', text: 'Sample policy mentions returns but does not specify the return window.' }, Exchanges: { status: 'Missing', text: '' }, Products: { status: 'Ready', text: '342 sample products across 8 collections.' }, 'Store Information': { status: 'Ready', text: 'Rang — sarees for everyday moments and celebrations.' }, FAQs: { status: 'Missing', text: '' } }, discovery: true, productHelp: true, proactive: true, welcome: 'Need help finding the perfect saree?', productMessage: 'Have a question about this saree?', productActions: ['Product details','Delivery','Returns','Similar products'], intents: ['Wedding', 'Festive', 'Everyday', 'Gift'], color: '#682539', logo: '', events: [], activity: false, replyStopped: {}, assigned: {}, replies: {}, notes: {}, questions: 0, firstPreview: null, widget: true, activeProducts:342,data:{carts:true,orders:true,consentSource:''},billing:{name:'Placeholder — replace with production pricing',price:'Not configured',employees:'Not configured',conversations:'Not configured'} }; }
...
export const people = [{ id: 'olivia', name: 'Olivia Martin', email: 'olivia@example.com', phone: 'Not provided', channel: 'Store chat', question: 'Is this saree suitable for a wedding?', unread: true, attention: false, orders: 2, spend: 178, interest: 'Wedding guest', source: 'Instagram', cart: 89 }, { id: 'ava', name: 'Ava Patel', email: 'ava@example.com', phone: 'Not provided', channel: 'Email', question: 'Can I exchange this after wearing it?', unread: false, attention: true, orders: 1, spend: 65, interest: 'Exchange policy', source: 'Direct', cart: 0 }, { id: 'ethan', name: 'Ethan Chen', email: 'ethan@example.com', phone: 'Not provided', channel: 'Instagram', question: 'Does the forest saree come in blue?', unread: false, attention: false, orders: 0, spend: 0, interest: 'Silk sarees', source: 'Instagram', cart: 110 }];
